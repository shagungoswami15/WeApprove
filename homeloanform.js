...
import "./homeloanform.css"; // Make sure to create this CSS file for styling
...
const HomeLoanForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.propertyDocs) submissionData.append("propertyDocs", formData.propertyDocs);
  
    try {
      const response = await fetch("http://localhost:5001/api/home-loan/apply", {
        method: "POST",
        body: submissionData,
      });
